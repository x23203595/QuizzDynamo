...
urlpatterns = [ 
    ...
    path('QuizzDynamoApp/Home/signout/', 
    views.StudentSignOut, name = 'SignOut'),
    path('QuizzDynamoApp/Home/AdminSignIn/', 
    views.AdminSignInMethod, name = 'AdminSignInPage'),
    ...
    views.InternetworkingSubmissionMethod, 
    name = 'InternetworkingSubmissionPage'),
